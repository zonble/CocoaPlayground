...
- (void)testLogin
{
	...
	[plurk addNewMessageWithContent:@"This is a test for testing the Objective-C API" qualifier:@"says" othersCanComment:OPEveryOneCanComment lang:@"en" limitToUsers:[NSArray array] delegate:self];
}
